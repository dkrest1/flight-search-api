  ...
  return (
    <div className="w-[100%]">
      ...
      <div className="hidden w-[100%] md:flex flex-col items-center mt-3 bg-white">
        <div
          className={`w-[90%] flex flex-col rounded-lg shadow-xl h- pb-10 px-2 mt-10 border-2 ${
            showFilter && "hidden"
          }`}
        >
          ...
          <div className="w-[100%]">
            <form
              ...
              className="flex flex-row mt-4 gap-5 mx-2 w-[100%]"
            >
              <div className="w-[45%] flex flex-row divide-x-2 rounded-lg border-2">
                <div
                  className={`w-[50%] flex flex-row divide-x py-4 items-center ${
                    errors &&
                ...
                >
                  ...
                  <div className="flex flex-col pl-1 w-full px-3">
                    <small className="text-xs text-slate-400 font-medium mb-1">
                      Departure
                    </small>
                    <div className={`w-full font-medium text-blue-950 `}>
                      <DropDownSearch
                        ...
                        options={options}
                        setError={setDepartureError}
                      />
                    </div>
                  </div>
                </div>
                <div
                  className={`w-[50%] flex flex-row divide-x pl-1 py-2 items-center ${
              ...
              <div className="w-[45%] flex flex-row divide-x-2  rounded-lg border-2">
                <div
                  className={`w-[50%] flex flex-row divide-x py-2 items-center ${
                ...
                <div className="w-[50%] flex flex-row divide-x  items-center mx-1 ">
                  ...
                  <div className="w-full flex flex-col ">
                    <small className="text-sm mx-1 text-slate-400 font-medium">
                      Passengers
                    </small>
                    <input
                      type="number"
              ...
              <div className="flex flex-row items-center w-[10%]">
                <button
                  className={`bg-blue-950 w-full mr-2 font-bold text-slate-200 py-4 px-3 rounded-lg ${
                    isPending && "w-20 px-2 bg-gray-600"
                  }`}
                  disabled={isPending}
                >
                  {" "}
