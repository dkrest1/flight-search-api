    ...
    <div>
      ...
      <div className="w-full ">
        ...
        <div className="w-[100%] flex flex-col items-center  mt-20">
          <div className="w-[90%] flex flex-col px-2 bg-slate-50 h-64 items-center rounded-sm">
              ...
              <div className="w-full flex flex-col border-b p-3">
                <div className="w-full flex flex-row justify-between">
                  ...
                  <div className=" flex flex-row text-sm gap-3">
                    <Link to='/bookings' className="border py-1 px-2 rounded">VIEW</Link>
              ...
              <div className="w-full flex flex-col mt-4 px-2">
                <div className="flex flex-row w-full justify-between">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p>First class | {passengers} Passengers</p>
                  </div>
                </div>
              </div>
            </div>
